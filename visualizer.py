...
class Visualizer():
    ...
    def parse_and_inject_sentences_into_HTML(self):
        stylized_group_names = {"sentences":"Sentences written in general","google_chrome":"Sentences written in Google Chrome"}
        self.group_names.extend(["google_chrome", "sentences"])
        ...
        for sentence_info in  li.get_clustered_keys():
            ...
            neccesary_sentence_information["group"] = self.group_names.index("sentences")
